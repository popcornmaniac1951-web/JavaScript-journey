...
let repeatedText = "apple banana apple";
console.log(repeatedText.lastIndexOf("apple"));
...
console.log(languageName.charAt(4));
...
let repeatedWords = "cat dog cat dog";
console.log(repeatedWords.replaceAll("dog", "lion"));
...
console.log(videoFile.endsWith(".mp4"));

//1.21 padstart
let invoiceNumber = "45";
console.log(invoiceNumber.padStart(5, "0"));

//1.22 padend
let productLabel = "Item";
console.log(productLabel.padEnd(10, "."));

//1.23 match
let sentenceLine = "I love JavaScript";
console.log(sentenceLine.match(/JavaScript/));

//1.24 search
let articleTitle = "Master JavaScript Quickly";
console.log(articleTitle.search("JavaScript"));
...
//1.26 valeof
let brandName = new String("Tesla");
console.log(brandName.valueOf());

//1.27 tostring
let wrappedString = new String("Coding");
console.log(wrappedString.toString());

//1.28 at()
let frameworkName = "ReactJS";
console.log(frameworkName.at(-1));

//1.29 matchall()
let dataString = "cat bat rat";
console.log([...dataString.matchAll(/at/g)]);
...
// Forms → trim(), includes(), replace()

// Authentication → startsWith(), slice()

// Data formatting → padStart(), toUpperCase()

// CSV parsing → split()

// Validation → match(), search()

// Master these and your development velocity increases dramatically.
